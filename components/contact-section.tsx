  ...
  return (
    <section id="contato" className="scroll-mt-24 p-2" aria-label="Contato">
      ...
      <a
        ...
        className="mt-6 inline-flex items-center gap-2 rounded-md bg-green-500 px-5 py-3 text-sm font-medium text-primary-foreground transition-opacity hover:opacity-90"
      >
